...
function MonthCal({ selectedMonth, onMonthSelect, callbacks, variant, minDate, maxDate, disabledDates, onYearBackward, onYearForward }: MonthCalProps) {
    ...
    const resolvedMinDate = minDate && maxDate && minDate > maxDate ? maxDate : minDate;
                                        ...
                                        >
                                            <button
                                                ...
                                                disabled={
                                                    ...
                                                    (resolvedMinDate ? menuYear < resolvedMinDate?.getFullYear() || (menuYear == resolvedMinDate?.getFullYear() && m.number < resolvedMinDate.getMonth()) : false) ||
